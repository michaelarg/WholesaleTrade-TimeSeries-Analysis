...
4. [Configuration and Methodology](#-configuration-and-methodology)
    - [4.1 Data Loading and Cleaning Pipeline](#31-data-loading-and-cleaning-pipeline)
    - [4.2 Core Processing and Metric Calculation](#32-core-processing-and-metric-calculation)
    - [4.3 Chart Generation (Verification)](#33-chart-generation-verification)
5. [Tableau Dashboard Documentation](#-tableau-dashboard-documentation)
    - [5.1 Chart 1: Nominal Sales Trend (Context)](#41-chart-1-nominal-sales-trend-context)
    - [5.2 Chart 2: Inventory-to-Sales Ratio (Inventory Risk)](#42-chart-2-inventory-to-sales-ratio-inventory-risk)
    - [5.3 Chart 3: Year-over-Year Sales Growth (Sales Momentum)](#43-chart-3-year-over-year-sales-growth-sales-momentum)
    - [5.4 Chart 4: Sales vs Inventories Levels (Comparative Validation)](#44-chart-4-sales-vs-inventories-levels-comparative-validation)
...
### 4.1 Data Loading and Cleaning Pipeline
...
### 4.2 Core Processing and Metric Calculation
...
### 4.3 Chart Generation (Verification)
...
<img width="1200" height="600" alt="1_nominal_sales_trend" src="https://github.com/user-attachments/assets/be0bc59c-76b9-4152-8f66-2a4e581727fd" />

### 5.2 Chart 2: Inventory-to-Sales Ratio (Inventory Risk)
- **Purpose:** Diagnoses supply-demand balance.  
- **Feature:** Average reference line acts as a risk benchmark.
  
<img width="1200" height="600" alt="2_nominal_is_ratio_trend" src="https://github.com/user-attachments/assets/4d0c1c30-18f6-4dc5-872e-3861d148fb8d" />

### 5.3 Chart 3: Year-over-Year Sales Growth (Sales Momentum)
...
<img width="1200" height="600" alt="3_yoy_sales_growth" src="https://github.com/user-attachments/assets/97afb93f-86b6-41b0-8f68-68dfe79f7ccf" />

### 5.4 Chart 4: Sales vs Inventories Levels (Comparative Validation)
...
<img width="1200" height="600" alt="4_sales_vs_inventories_levels" src="https://github.com/user-attachments/assets/7f491cb9-6433-481a-935a-2cc25d3ad2ec" />
